...
class Connect4:
    ...
    def amount_of_threats(self, maximazing_player):
        ...
        threats = 0
        for four in self.iter_fours():
                if four.count(token) == 1:
                    threats += 1
                elif four.count(token) == 2:
                    threats += 2
                elif four.count(token) == 3:
                    threats += 3
                    
                if four.count(opponent) == 1:
                    threats -= 1
                elif four.count(opponent) == 2:
                    threats -= 2
                elif four.count(opponent) == 3:
                    threats -= 3    
        return threats / 1000
